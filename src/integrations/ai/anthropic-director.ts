...
const SYSTEM_PROMPT = [
  ...
  '- body: 1-2 Korean sentences. State the chosen candidate\'s `direction` phrase (compass + distance) plainly. Do NOT invent street names, turn-by-turn steps, or landmarks you were not given.',
  '- hint: one Korean sentence combining the direction and the place category.',
